-- Demo authentication support for the table-backed app session.
...
CREATE OR REPLACE FUNCTION public.create_app_user(new_email text, new_password text, new_role text)
RETURNS uuid
